...
public class GraduateProjectCategoryController extends HttpServlet {
    /**
     * POST, http://49.235.39.226:8080/bysj/graduateProjectCategory.ctl, 增加毕业项目类别
     * 增加一个毕业项目类别对象：将来自前端请求的JSON对象，增加到数据库表中
     * @param request 请求对象
     * @param response 响应对象
    ...
    /**
     * DELETE, http://49.235.39.226:8080/bysj/graduateProjectCategory.ctl?id=1, 删除id=1的毕业项目类别
     * 删除一个毕业项目类别对象：根据来自前端请求的id，删除数据库表中id的对应记录
     * @param request
     * @param response
     * @throws ServletException
     * @throws IOException
    ...
    /**
     * PUT, http://49.235.39.226:8080/bysj/graduateProjectCategory.ctl, 修改毕业项目类别
     *
     * 修改一个毕业项目类别对象：将来自前端请求的JSON对象，更新数据库表中相同id的记录
     * @param request
     * @param response
     * @throws ServletException
     * @throws IOException
    ...
    /**
     * GET, http://49.235.39.226:8080/bysj/graduateProjectCategory.ctl?id=1, 查询id=1的毕业项目类别
     * GET, http://49.235.39.226:8080/bysj/graduateProjectCategory.ctl, 查询所有的毕业项目类别
     * 把一个或所有毕业项目类别对象响应到前端
     * @param request
     * @param response
     * @throws ServletException
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        JSONObject message = new JSONObject();
        try {
            //如果id = null, 表示响应所有毕业项目类别对象，否则响应id指定的毕业项目类别对象
            if (id_str == null) {
