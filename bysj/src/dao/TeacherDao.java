...
public final class TeacherDao {
	...
	public Teacher findByNo(String no) throws SQLException{
		...
		String teacher_sql = "SELECT * FROM Teacher where no = ?";
	...
	public boolean add(Teacher teacher){
		...
		try{
			...
			//创建sql语句
			String addTeacher_sql="Insert into Teacher (name,no) values (?,?)";
			//在该连接上创建预编译语句对象
	...
	public boolean update(Teacher teacher)throws ClassNotFoundException,SQLException{
		Connection connection = JdbcHelper.getConn();
		//写sql语句
		String updateTeacher_sql = " update teacher set name=?,no = ? where id=?";
		//在该连接上创建预编译语句对象
