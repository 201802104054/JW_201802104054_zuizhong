...
public class GraduateProjectType implements
		Comparable<GraduateProjectType>, Serializable {
	//声明Integer类型私有字段id
	private Integer id;
	...
	//定义GraduateProjectType构造器，传入形参，完成四个字段的对象指向
	public GraduateProjectType(Integer id, String description, String no, String remarks) {
		this(description, no, remarks);
		this.id = id;
	}
	//定义GraduateProjectType构造器，传入形参，完成五个字段的对象指向
	public GraduateProjectType(String description, String no, String remarks) {
